    ...
    <div className="relative flex min-h-screen flex-col">
      ...
      <header className="sticky top-0 z-40 border-b border-border/40 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-5 py-3.5 sm:px-8">
          ...
          >
            <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-br from-accent to-primary text-[0.6rem] font-bold text-primary-foreground">
              672
            </span>
